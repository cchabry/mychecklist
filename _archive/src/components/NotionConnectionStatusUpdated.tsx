...
/**
 * Version améliorée du composant NotionConnectionStatus
 * Utilise le nouveau système operationMode
 */
const NotionConnectionStatusUpdated: React.FC<NotionConnectionStatusUpdatedProps> = ({
  onConfigClick,
  onReset,
  className = '',
  compact = false
...
export default NotionConnectionStatusUpdated;
