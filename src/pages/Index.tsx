  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-background to-secondary/30">
      ...
      <main className="flex-1 container px-4 py-8 mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold mb-3">Audits Qualité Web</h1>
        ...
        >
          ...
          {projects.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center bg-white/50 backdrop-blur-sm rounded-lg border border-border/60">
